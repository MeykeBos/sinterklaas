...
video_file = open('C:/Users/vandemey/OneDrive - TomTom/Pictures/december_madness/Haan/video_julie.mp4', 'rb')
...
with st.expander("\U0001F575	 Hoe nu verder? "):
    ...
    st.write(''' ''')
    st.write('''### Plek 1''')
    plek1 = Image.open('C:/Users/vandemey/OneDrive - TomTom/Pictures/december_madness/Haan/plek1.jpeg')
    st.image(plek1, width=300)
    st.write('''### Plek 2''')
    plek2 = Image.open('C:/Users/vandemey/OneDrive - TomTom/Pictures/december_madness/Haan/plek2.jpeg')
    st.image(plek2, width=300)
    st.write('''### Plek 3''')
    plek3 = Image.open('C:/Users/vandemey/OneDrive - TomTom/Pictures/december_madness/Haan/plek3.jpeg')
    st.image(plek3, width=300)
    st.write('''### Plek 4''')
    plek4 = Image.open('C:/Users/vandemey/OneDrive - TomTom/Pictures/december_madness/Haan/plek4.jpeg')
    st.image(plek4)
